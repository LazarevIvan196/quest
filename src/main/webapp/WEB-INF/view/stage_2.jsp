...
<head>
    ...
    <style>
        body {
            background-image: url('${pageContext.request.contextPath}/images/stage_2.jpg');
            ...
            fetch("${pageContext.request.contextPath}/startGame", {
                ...
                .then(data => {
                    ...
                    if (data.redirectToStage) {
                        window.location.href = "${pageContext.request.contextPath}/stage_5";
                    }
                })
                .catch(error => {
        ...
        function handleActionTwo() {
            fetch("${pageContext.request.contextPath}/startGame", {
                ...
                .then(data => {
                    ...
                    if (data.redirectToStage) {
                        window.location.href = "${pageContext.request.contextPath}/stage_6";
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
    ...
    <form action="${pageContext.request.contextPath}/startGame" method="post" style="text-align: center; margin-top: 100px;">
        ...
        <p id="stageText">
            <%
                ...
                if (stage0Data != null) {
                    Object stage0Obj = stage0Data.get("STAGE_2");
        ...
        <div class="button" style="display: flex; justify-content: space-between; margin-top: 10px;">
            <button type="button" onclick="handleActionOne()">Рискнуть</button>
            <button type="button" onclick="handleActionTwo()">Вернуться</button>
